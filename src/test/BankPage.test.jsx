...
describe("BankPage", () => {
  ...
  function renderBank() {
    ...
    return render(<MemoryRouter initialEntries={["/course/ctai/bank"]}><Routes><Route path="/course/:courseId/bank" element={<BankPage courses={courses} />} /></Routes></MemoryRouter>);
  }
